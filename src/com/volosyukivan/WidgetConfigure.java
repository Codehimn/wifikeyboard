...
public class WidgetConfigure extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ok.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View v) {
        SharedPreferences prefs = getSharedPreferences(PREFS_WIDGETS,
            Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = prefs.edit();
        editor.putBoolean(textEnableProperty(mAppWidgetId), enabled.isChecked());
        editor.putString(textStringProperty(mAppWidgetId), editText.getText()
            .toString());
        editor.commit();
        WidgetProvider.log(WidgetConfigure.this, "Widget " + mAppWidgetId
            + " configured");

        AppWidgetManager appWidgetManager = AppWidgetManager
            .getInstance(WidgetConfigure.this);
  ...
  static void deleteWidget(Context context, int id) {
    SharedPreferences.Editor editor = context.getSharedPreferences(
        PREFS_WIDGETS, Context.MODE_PRIVATE).edit();
  ...
  static void updateWidget(Context context, AppWidgetManager appWidgetManager,
      int id) {
    SharedPreferences prefs = context.getSharedPreferences(PREFS_WIDGETS,
        Context.MODE_PRIVATE);
